...
<!-- action-docs-usage source="action.yml" project="gce-digital-marketing-infrastructure/ACTION-teams-notifier" version="v2.0.2" -->
## Usage

```yaml
- uses: gce-digital-marketing-infrastructure/ACTION-teams-notifier@v2.0.2
  with:
    webhook_url:
...
```yaml
- uses: aliciousness/teams-notifier@v2.0.0
  with:
    webhook_url:
    # The Microsoft Teams Incoming Webhook URL
    #
